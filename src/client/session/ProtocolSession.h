...
public slots:
    ...
    void sendClipboardFileChunk(quint32 fileIndex, const QByteArray& data, bool lastChunk);
    void sendFileTransferChunk(quint32 fileIndex, quint32 seq, const QByteArray& data);
